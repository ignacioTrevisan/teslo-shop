...
import { UserAddress, UserAddressWithUserId } from '@/interface/UserAddress';
...
interface Props {
    ...
    userStoreAddress?: Partial<UserAddressWithUserId>;
}
export const AddresForm = ({ countries, userStoreAddress = {} }: Props) => {
    ...
    const onSubmit = async (data: FormInputs) => {
        ...
        if (data.rememberAddress) {
            const resp = await setUserAddress(data, session.user.id)
            if (resp.ok) {
